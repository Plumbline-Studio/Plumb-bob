// Order page wiring: price lookup for the chosen catalog item, and the
// Place Order handler that carries the order to the confirmation page.
const PRICES = {
...
document.getElementById("place-order").addEventListener("click", () => {
  ...
  location.href = `confirm.html?${next.toString()}`;
});
